...
Something to investigate: An [approach](https://github.com/antfu/eslint-config#editor-specific-disables) to ignoring style rules in VS Code, and possibly migrate all style handling to ESLint instead of Prettier.
