...
async function buildCommands(command2, logPrefix, logColor, subcommands) {
  ...
  if (subcommands.lint !== void 0) {
    yargsInstance.command({
      builder(yargs) {
        return subcommands.lint?.defaultArguments === void 0 ? yargs : yargs.positional("files", {
          array: true,
      ...
      command: subcommands.lint.defaultArguments === void 0 ? "lint" : "lint [files..]",
      describe: "Check for and report issues.",
      async handler(argv) {
        const input = argv.files ?? subcommands.lint?.defaultArguments ?? [];
