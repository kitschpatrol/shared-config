...
export const jsonPackageRecommendedRules: Rules = {
	...
	'json-package/require-attribution': 'error',
	'json-package/require-description': 'error',
	'json-package/require-exports': 'error',
	'json-package/require-files': 'error',
	'json-package/require-license': 'error',
	'json-package/require-name': 'error',
	'json-package/require-repository': 'error',
	'json-package/require-sideEffects': 'error',
	...
	'json-package/valid-browser': 'error',
	'json-package/valid-bugs': 'error',
	...
	'json-package/valid-peerDependenciesMeta-relationship': 'error',
