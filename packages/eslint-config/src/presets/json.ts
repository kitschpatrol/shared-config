...
export const jsonRecommendedWithJsonCommonRules: Rules = {
...
export const jsonRecommendedWithJsonRules: Rules = {
...
export const jsonRecommendedWithJsoncRules: Rules = {
...
export const jsonRecommendedWithJson5Rules: Rules = {
...
export const jsonPrettierRules: Rules = {
