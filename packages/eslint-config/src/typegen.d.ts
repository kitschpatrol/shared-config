...
export interface RuleOptions {
	...
	/**
	 * Reports redundant @type tags that match or broaden the naturally inferred
	 * TypeScript type.
	 */
	...
	/**
	 * Disallows (or requires descriptions for) `@ts-<directive>` comments,
	 * mirroring `@typescript-eslint/ban-ts-comment`.
	 *
	...
	/**
	 * Require that dependencies declared with workspace protocol use a rolling
	 * workspace spec instead of a specific semver range.
	 *
	 * @see https://eslint-plugin-package-json.dev/rules/prefer-rolling-workspace-spec
	 */
	'json-package/prefer-rolling-workspace-spec'?: Linter.RuleEntry<JsonPackagePreferRollingWorkspaceSpec>
	/**
	...
	/**
	 * Disallows DOM elements from using 'dangerouslySetInnerHTML' and 'children'
	 * at the same time.
	 *
	...
	/**
	 * Enforces that the 'sandbox' attribute for 'iframe' elements is not set to
	 * unsafe combinations.
	 *
	 ...
	 * ensuring that side effects must run outside of render.
	 *
	 ...
	 * including through functions passed into frozen contexts such as JSX props,
	 * hook arguments, and hook return values.
	 *
	...
	/**
	 * Disallows passing 'children' as a prop when children are also passed as
	 * nested content.
	 *
	...
	/**
	 * Prevents comment strings from being accidentally inserted into a JSX
	...
	/**
	 * Prevent patterns that cause deoptimization when using the automatic JSX
	 * runtime.
	 *
	...
	/**
	 * Catches `$` before `{expr}` in JSX — typically from template literal
	 * `${expr}` being copy-pasted into JSX without removing the `$`. The `$`
	...
	/**
	 * Catches `;` at the start of JSX text nodes — typically from accidentally
	 * placing a statement-ending `;` inside JSX. The `;` "leaks" into the
	 * rendered output.
	 *
	...
	/**
	 * Enforces identifier names assigned from `createContext` calls to be a valid
	 * component name with the suffix `Context`.
	 *
	 * @see https://eslint-react.xyz/docs/rules/naming-convention-context-name
	 */
	'react/naming-convention-context-name'?: Linter.RuleEntry<[]>
	/**
	 * Enforces identifier names assigned from 'useId' calls to be either 'id' or
	 * end with 'Id'.
	 *
	...
	/**
	 * Enforces identifier names assigned from 'useRef' calls to be either 'ref'
	 * or end with 'Ref'.
	 *
	...
	/**
	 * Replaces usage of 'componentWillReceiveProps' with
	...
	/**
	 * Disallows nesting lazy component declarations inside other components or
	 * hooks.
	 *
	...
	/**
	 * Disallows calling 'this.setState' in 'componentDidMount' outside functions
	 * such as callbacks.
	 *
	...
	/**
	 * Disallows calling 'this.setState' in 'componentDidUpdate' outside functions
	 * such as callbacks.
	 *
	...
	/**
	 * Disallows calling 'this.setState' in 'componentWillUpdate' outside
	...
	/**
	 * Enforces that a function with the 'use' prefix uses at least one Hook
	 * inside it.
	 *
	...
	/**
	 * Warns about the use of 'UNSAFE_componentWillReceiveProps' in class
	 * components.
	 *
	...
	/**
	 * Validates that components and hooks are pure by checking that they do not
	 * call known-impure functions during render.
	 *
	 * @see https://eslint-react.xyz/docs/rules/purity
	 */
	'react/purity'?: Linter.RuleEntry<[]>
	/**
	 * Validates correct usage of refs by checking that 'ref.current' is not read
	...
	/**
	 * Validates against setting state synchronously in an effect, which can lead
	...
	/**
	 * Validates against unconditionally setting state during render, which can
	 * trigger additional renders and potential infinite render loops.
	 *
	...
	/**
	 * Enforces correct usage of 'useState', including destructuring, symmetric
	 * naming of the value and setter, and wrapping expensive initializers in a
	...
	/**
	 * Enforces that every 'addEventListener' in a component or custom hook has a
	...
	/**
	 * Enforces that every 'IntersectionObserver' created in a component or custom
	 * hook has a corresponding 'IntersectionObserver.disconnect()'.
	 *
	...
	/**
	 * Enforces that every 'setInterval' in a component or custom hook has a
	 * corresponding 'clearInterval'.
	 *
	 * @see https://eslint-react.xyz/docs/rules/web-api-no-leaked-interval
	 */
	'react/web-api-no-leaked-interval'?: Linter.RuleEntry<[]>
	/**
	 * Enforces that every 'ResizeObserver' created in a component or custom hook
	 * has a corresponding 'ResizeObserver.disconnect()'.
	 *
	 * @see https://eslint-react.xyz/docs/rules/web-api-no-leaked-resize-observer
	 */
	'react/web-api-no-leaked-resize-observer'?: Linter.RuleEntry<[]>
	/**
	 * Enforces that every 'setTimeout' in a component or custom hook has a
	...
	/**
	 * Replaced by `unicorn/prefer-unicode-code-point-escapes` which covers more
	 * cases.
	 *
	 * @deprecated
	...
	/**
	 * Replaced by `unicorn/no-unused-builtin-method-return` which covers more
	 * cases.
	 *
	 * @deprecated
...
// ----- json-package/prefer-rolling-workspace-spec -----
type JsonPackagePreferRollingWorkspaceSpec =
	| []
	| [
			{
...
type UnicornLogicalAssignmentOperators = (
	| []
	| ['always']
	| [
			'always',
...
type _UnicornNameReplacementsReplacements =
	(false | _UnicornNameReplacements_BooleanObject) | undefined
...
type UnicornSingleLineBlockCommentStyle =
	| []
...
export type ConfigNames =
	...
	| 'kp/json/rules-json5'
	| 'kp/json/rules'
	| 'kp/json/rules-settings'
	| 'kp/json/rules-package'
	| 'kp/json/rules-tsconfig'
	| 'kp/json/rules-overrides'
	| 'kp/jsx/rules'
	| 'kp/markdown/remark'
	| 'kp/markdown/code-blocks'
	| 'kp/mdx/remark'
	| 'kp/mdx/code-blocks'
	| 'kp/react/setup'
	| 'kp/react/rules'
	| 'kp/react/disable-type-aware'
	| 'kp/svelte/setup'
	| 'kp/svelte/scripts'
	| 'kp/svelte/component'
	| 'kp/svelte/rules'
	| 'kp/svelte/sveltekit-routes'
	| 'kp/svelte/sveltekit-app'
	| 'kp/svelte/modules'
	| 'kp/test/setup'
	| 'kp/test/rules'
	| 'kp/toml/setup'
