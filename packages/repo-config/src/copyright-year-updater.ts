...
const licenseBoilerplateDatePatterns: RegExp[] = [
	// Apache License 2.0
	/Version 2\.0,?\s*January 2004/gv,
	// GPL v1
	/Version 1,?\s*February 1989/gv,
	// GPL v2 / LGPL v2
	/Version 2,?\s*June 1991/gv,
	// GPL v3 / LGPL v3
	/Version 3,?\s*29 June 2007/gv,
	// LGPL v2.1
	/Version 2\.1,?\s*February 1999/gv,
	// AGPL v3
	/Version 3,?\s*19 November 2007/gv,
	// Boost Software License 1.0
	/Version 1\.0\s*-\s*August 17th,?\s*2003/gv,
	// GFDL v1.1
	/Version 1\.1,?\s*March 2000/gv,
	// GFDL v1.2
	/Version 1\.2,?\s*November 2002/gv,
	// GFDL v1.3
	/Version 1\.3,?\s*3 November 2008/gv,
	// SIL Open Font License 1.0
	/Version 1\.0\s*-\s*22 November 2005/gv,
	// SIL Open Font License 1.1
	/Version 1\.1\s*-\s*26 February 2007/gv,
	// WTFPL v2
	/Version 2,?\s*December 2004/gv,
	// WIPO copyright treaty reference (GPL v3, AGPL v3, CC 4.0)
	/20 December 1996/gv,
	/December 20,?\s*1996/gv,
	// EU directive reference (CC 4.0, CC0)
	/11 March 1996/gv,
	// GPL v3 / AGPL v3 patent clause date
	/28 March 2007/gv,
	// GFDL v1.3 specific dates
	/November 1,?\s*2008/gv,
	/August 1,?\s*2009/gv,
	// GPL appendix example signature dates
	/1 April 19\d{2}/gv,
	// Artistic License 2.0 copyright
	/Copyright \(c\) 2000-2006,?\s*The Perl Foundation/giv,
	// FSF copyright lines in license texts
	/Copyright \(C\) (?:\d{4},?\s*)+Free Software Foundation/gv,
]
...
function maskLicenseBoilerplateDates(content: string): string {
	...
	for (const pattern of licenseBoilerplateDatePatterns) {
		pattern.lastIndex = 0
		masked = masked.replace(pattern, (match) => match.replaceAll(/\d/gv, 'X'))
	}

	return masked
}

const YEAR_RANGE_REGEX = /(\d{4})\s*-\s*(\d{4})/v
const YEAR_REGEX = /(\d{4})/v
